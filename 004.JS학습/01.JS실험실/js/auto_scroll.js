...
// (1-2) body에 오버플로우 히든 설정
// myFn.qs("html").style.overflow = "hidden";
...
function wheelFn(e) {
  ...
  // (4-7) 페이지번호와 일치하는 GNB와 인디케이터에 클래스 on넣기
