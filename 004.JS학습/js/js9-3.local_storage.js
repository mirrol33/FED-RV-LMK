...
// myFn.qs('body').onclick = ()=>{sessionStorage.removeItem('my-dog')};
...
/////////////////////////////////////////////
// 데이터 추가 버튼 클릭시 데이터 삭제하기 //
///////////////////////////////////////////
// 대상: .del-link a (삭제버튼)
// 처음 로딩시 삭제버튼에 클릭이벤트를 설정하게 되면
// 삭제후 리스트가 변경됨에따라 기존에 설정도니 이벤트가 사라짐!
// -> 주의!중요!! 일반적으로 형제요소중 DOM구조가 변경될 시
...
// 추가로 각 출력영역을 클릭하면 해당 로컬쓰만 지우기셋팅
// 배우이름 삭제
