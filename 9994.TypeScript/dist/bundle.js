...
const teamManager = {
    ...
    managerRoles: [Role.Frontend, Role.Backend, Role.Fullstack],
};
// 8. 제네릭을 활용한 중급, 고급 개발자 필터함수 만들기
// 기준 : 중고급 개발자는 경력 5년이상이다!
// 기존에 경력년수가 없으므로 year속성을 추가함!
...
// 데이터형을 지정하지 않아도 자동으로 형을 감지한다!(타입추론)
// printArray<number>(numberArray);
printArray(numberArray);
const stringArray = ["코딩의신", "타입스크립트", "리액트"];
