...
function SerchingCat({selData}) {
  ...
  return (
    <>
      ...
      {
        // 데이터가 없을 경우
        total === 0 && <h2 style={{textAlign: "center"}}>Sorry, we don't have any matches for that. But there's plenty more to see on DC!</h2>
      }
    </>
  );
}

export default SerchingCat;
