...
/* 
    ...
    (소괄호 생략 가능! 단, 소괄호든 태그든 return키워드 바로 옆에 같은 줄에 있어야 유효하다!)
...
function MyFirstReact() {
  ...
  return (
    <React.Fragment>
      ...
      <img src="https://blog.kakaocdn.net/dn/BFjKm/btqARynJAZ8/gKgl3Wzf5dm588Q6WKwlr0/img.png" alt="리액트 로고" style={{width: "100%"}} />
      <h2>
        [ 리액트란 무엇인가? ]
        <br />
